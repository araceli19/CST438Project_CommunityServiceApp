...
<!--  <nav class="navbar navbar-inverse"> -->
      ...
      <ul align="right" class="nav navbar-nav">
          ...
          <li> <a href= "public/html/Search.php"><h5>Services</h5></a></li>
          <li><a href= "public/html/volunteer_profile.html"><h5>My Profile</h5></a></li>
          <li><a href= "public/html/contactUs.html"><h5>Contact Us</h5></a></li>
      </ul>
    </div>
<!--  </nav>  -->
  ...
  <input type="submit" name="withGmail" id="enter" value="Login as Volunteer" />
      ...
      <?php
               echo '<div style="margin:20px">';
                if (isset($authUrl)) {
                       echo '<div align="left">';
                       echo '<a class="login" href="' . $authUrl . '"><img src="public/html/images/gmail_btn.png" /></a>';
               echo '</div>'; }
